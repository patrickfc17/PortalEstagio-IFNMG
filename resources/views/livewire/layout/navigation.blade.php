               ...
               <div class="flex items-center shrink-0">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger" >
                            <button class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 transition duration-150 ease-in-out border border-transparent rounded-md text-paper bg-leaf hover:text-leaf focus:outline-none">
                                {{ __('Mais') }}
